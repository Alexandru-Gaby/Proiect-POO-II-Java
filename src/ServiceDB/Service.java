...
public class Service {
    ...
    public Service(ClientService clientService, CarService carService,
                   ReservationService reservationService, PaymentService paymentService) {
        this.clientService = clientService;
        this.carService = carService;
        this.reservationService = reservationService;
        this.paymentService = paymentService;
        this.additionalServiceService = new AdditionalServiceService();
    }
    ...
    public void reserveCarWithServices(Client client, int carId, LocalDateTime start, LocalDateTime end,
    ...
    // Metode pentru servicii suplimentare
    public List<AdditionalService> getAllAdditionalServices() {
        return additionalServiceService.getAllServices();
    }

    public AdditionalService addInsuranceService() {
        return additionalServiceService.addInsuranceService();
    }

    public AdditionalService addRoadAssistance() {
        return additionalServiceService.addRoadAssistance();
    }
}